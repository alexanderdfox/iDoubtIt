...
class PlayScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        players[1].position = CGPoint(x: screenWidth / 4, y: screenHeight / 2 - players[1].size.height)
        players[2].position = CGPoint(x: screenWidth / 4, y: screenHeight / 2 - players[2].size.height)
        players[3].position = CGPoint(x: screenWidth / 4, y: screenHeight / 2 - players[3].size.height)
        players[0].zRotation = CGFloat(0 * Double.pi / 2 / 360)
        players[1].zRotation = CGFloat(360 * Double.pi / 2 / 360)
        players[2].zRotation = CGFloat(720 * Double.pi / 2 / 360)
        players[3].zRotation = CGFloat(1080 * Double.pi / 2 / 360)
